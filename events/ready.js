module.exports = {
  ...
  async execute(client) {
    ...
    console.log('Thanks you much for using our code! <3')
    console.log('https://discord.gg/7KtdeePrHV')
    console.log('https://www.youtube.com/channel/UCwsiWQMSomXFjWWpRQbc35A');
